...
export type AreaEmergencia = "agitacao" | "delirium" | "suicidio" | "serotoninergica" | "snm" | "abstinencia_bzd" | "litio" | "catatonia" | "conversiva";
...
const abstinencia_bzd: Protocolo = {
  id: "abstinencia_bzd",
  titulo: "Abstinência de Benzodiazepínicos",
  area: "abstinencia_bzd",
  cor: "orange",
  descricao: "Manejo da síndrome de abstinência de BZDs — risco de convulsão e óbito.",
  tempo_min: 10,
  plano: "free",
  referencia: "NICE CG115. 2011; Ashton H. Br J Psychiatry. 2005.",
  inicio: "bzd_alerta",
  nos: [
    {
      id: "bzd_alerta",
      tipo: "aviso",
      titulo: "Sinais de alerta — encaminhar UPA/UTI",
      conteudo: "Avalie imediatamente se há critérios de gravidade que exigem suporte intensivo.",
      alerta: { tipo: "perigo", texto: "Taquicardia >120 bpm, temperatura >38°C, agitação grave ou convulsão = encaminhar UPA/UTI imediatamente." },
      proximo: "bzd_tempo",
    },
    {
      id: "bzd_tempo",
      tipo: "pergunta",
      titulo: "Tempo sem BZD",
      conteudo: "Há quanto tempo o paciente está sem benzodiazepínico?",
      opcoes: [
        { label: "Menos de 24 horas", proximo: "bzd_ciwa_menor24" },
        { label: "24 a 72 horas", proximo: "bzd_ciwa_24a72" },
        { label: "Mais de 72 horas", proximo: "bzd_ciwa_maior72" },
      ],
    },
    {
      id: "bzd_ciwa_menor24",
      tipo: "pergunta",
      titulo: "Escala CIWA-B — < 24h sem BZD",
      conteudo: "Qual a pontuação na escala CIWA-B (Benzodiazepine)?",
      opcoes: [
        { label: "CIWA-B ≥ 15 — abstinência grave", proximo: "bzd_internacao" },
        { label: "CIWA-B 8–14 — abstinência moderada", proximo: "bzd_ambulatorio" },
        { label: "CIWA-B < 8 — abstinência leve", proximo: "bzd_orientacao" },
      ],
    },
    {
      id: "bzd_ciwa_24a72",
      tipo: "pergunta",
      titulo: "Escala CIWA-B — 24 a 72h sem BZD",
      conteudo: "Qual a pontuação na escala CIWA-B? (pico de abstinência habitual nesta janela)",
      opcoes: [
        { label: "CIWA-B ≥ 15 — abstinência grave", proximo: "bzd_internacao" },
        { label: "CIWA-B 8–14 — abstinência moderada", proximo: "bzd_ambulatorio" },
        { label: "CIWA-B < 8 — abstinência leve", proximo: "bzd_orientacao" },
    ...
    },
    {
      id: "bzd_ciwa_maior72",
      tipo: "pergunta",
      titulo: "Escala CIWA-B — > 72h sem BZD",
      conteudo: "Qual a pontuação na escala CIWA-B?",
      alerta: { tipo: "atencao", texto: "Convulsões por abstinência de BZD podem ocorrer tardiamente, até 1–2 semanas após interrupção abrupta." },
      opcoes: [
        { label: "CIWA-B ≥ 15 — abstinência grave", proximo: "bzd_internacao" },
        { label: "CIWA-B 8–14 — abstinência moderada", proximo: "bzd_ambulatorio" },
        { label: "CIWA-B < 8 — abstinência leve", proximo: "bzd_orientacao" },
    ...
    },
    {
      id: "bzd_internacao",
      tipo: "acao",
      titulo: "CIWA-B ≥ 15 — Internação indicada",
      conteudo: "Abstinência grave exige monitorização hospitalar e titulação de diazepam EV/VO.",
      alerta: { tipo: "perigo", texto: "Risco de convulsão, delirium e morte. Não manejar ambulatorialmente." },
      acoes: [
        "Internar em leito com monitorização de sinais vitais",
        "Diazepam 10–20 mg EV lento a cada 1–2h até CIWA-B < 8 (protocolo de carga)",
        "Monitorar nível de consciência e frequência respiratória",
        "Tiamina 300 mg EV se uso concomitante de álcool",
        "Avaliar convulsão: diazepam EV é anticonvulsivante e trata abstinência simultaneamente",
      ],
      proximo: "bzd_desmame",
    },
    {
      id: "bzd_ambulatorio",
      tipo: "acao",
      titulo: "CIWA-B 8–14 — Ambulatório monitorado",
      conteudo: "Substituição por diazepam oral equivalente com reavaliação frequente.",
      acoes: [
        "Calcular dose equivalente em diazepam (ver tabela de equivalências)",
        "Diazepam VO fracionado 3–4x/dia, titular conforme CIWA-B",
        "Retorno em 24–48h para reavaliação obrigatória",
        "Orientar paciente e familiar sobre sinais de piora (convulsão, confusão)",
        "Evitar BZD de curta ação durante a troca",
      ],
      proximo: "bzd_equivalencias",
    },
    {
      id: "bzd_orientacao",
      tipo: "acao",
      titulo: "CIWA-B < 8 — Orientação ambulatorial",
      conteudo: "Abstinência leve pode ser manejada com desmame gradual orientado.",
      acoes: [
        "Orientar sobre risco de interrupção abrupta e importância do desmame",
        "Iniciar plano de desmame gradual (ver próximo nó)",
        "Fornecer contato de retorno se sintomas piorarem",
        "Considerar propranolol 10–20 mg para sintomas autonômicos leves",
      ],
      proximo: "bzd_equivalencias",
    },
    {
      id: "bzd_equivalencias",
      tipo: "info",
      titulo: "Tabela de equivalências — Diazepam",
      conteudo: "Converta a dose atual para diazepam oral equivalente:",
      acoes: [
        "Alprazolam 1 mg = Diazepam 10 mg",
        "Clonazepam 0,5 mg = Diazepam 10 mg",
        "Lorazepam 1 mg = Diazepam 10 mg",
        "Bromazepam 6 mg = Diazepam 10 mg",
        "Midazolam 5 mg = Diazepam 10 mg",
        "Nitrazepam 5 mg = Diazepam 10 mg",
        "Use a dose diária total equivalente como ponto de partida para o desmame",
      ],
      proximo: "bzd_desmame",
    },
    {
      id: "bzd_desmame",
      tipo: "resultado",
      titulo: "Plano de desmame",
      conteudo: "Redução gradual e individualizada — nunca interrupção abrupta.",
      acoes: [
        "Redução de 10% da dose a cada semana como regra geral",
        "Desmame mais lento se uso > 5 anos, doses altas ou tentativas anteriores frustradas",
        "Paciente pode solicitar pausas no desmame — respeitar para evitar recaídas",
        "Psicoterapia (TCC) como suporte essencial durante o desmame",
        "Monitoramento ambulatorial com CIWA-B a cada consulta",
        "Evitar troca para outro BZD de ação curta durante o processo",
      ],
    },
  ],
};
...
const litio: Protocolo = {
  id: "litio",
  titulo: "Intoxicação por Lítio",
  area: "litio",
  cor: "yellow",
  descricao: "Reconhecimento e manejo da toxicidade por lítio — potencialmente fatal.",
  tempo_min: 8,
  plano: "free",
  referencia: "Lithium toxicity. UpToDate 2024; Stahl's 7ª ed.",
  inicio: "litio_suspeita",
  nos: [
    {
      id: "litio_suspeita",
      tipo: "aviso",
      titulo: "Suspeitar sempre em usuários de lítio",
      conteudo: "Qualquer paciente em uso de lítio com sintomas neurológicos deve ser avaliado para intoxicação.",
      alerta: { tipo: "atencao", texto: "A janela terapêutica do lítio é estreita (0,6–1,2 mEq/L). Intoxicação pode ocorrer mesmo com doses habituais." },
      proximo: "litio_nivel",
    },
    {
      id: "litio_nivel",
      tipo: "pergunta",
      titulo: "Nível sérico disponível?",
      conteudo: "O resultado da litemia está disponível?",
      opcoes: [
        { label: "Sim — nível sérico disponível", proximo: "litio_classificacao" },
        { label: "Não — coletar urgente", proximo: "litio_sem_nivel" },
      ],
    },
    {
      id: "litio_sem_nivel",
      tipo: "acao",
      titulo: "Nível não disponível — tratar como moderado",
      conteudo: "Na ausência de litemia, adote conduta de intoxicação moderada enquanto aguarda o resultado.",
      acoes: [
        "Coletar litemia urgente (resultado em 1–2h se disponível)",
        "Suspender lítio imediatamente",
        "Suspender AINEs, tiazídicos e IECA (aumentam litemia)",
        "Iniciar hidratação com SF 0,9% EV",
        "Monitorizar ECG contínuo",
        "Reavaliar ao obter o nível sérico",
      ],
      proximo: "litio_classificacao",
    },
    {
      id: "litio_classificacao",
      tipo: "info",
      titulo: "Classificação por nível sérico",
      conteudo: "Correlação entre litemia e apresentação clínica:",
      acoes: [
        "LEVE (< 1,5 mEq/L): tremor fino, polidipsia, poliúria, náusea, diarreia",
        "MODERADO (1,5–2,0 mEq/L): ataxia, disartria, confusão, letargia, fraqueza muscular",
        "GRAVE (> 2,0 mEq/L): convulsão, coma, arritmia cardíaca, crise miastênica",
        "NOTA: sintomas neurológicos podem ocorrer com níveis 'normais' em intoxicação crônica",
      ],
      proximo: "litio_acoes_imediatas",
    },
    {
      id: "litio_acoes_imediatas",
      tipo: "acao",
      titulo: "Ações imediatas — todos os casos",
      conteudo: "Independente da gravidade, iniciar imediatamente:",
      acoes: [
        "Suspender lítio",
        "Suspender AINEs, tiazídicos e IECA",
        "Hidratação: SF 0,9% EV 150–200 mL/h (corrige depleção de sódio que eleva litemia)",
        "Monitorização: ECG, eletrólitos, função renal a cada 4–6h",
        "NÃO usar carvão ativado — lítio não é adsorvido",
        "NÃO forçar diurese com furosemida — piora a retenção de lítio",
      ],
      proximo: "litio_hemodialise",
    },
    {
      id: "litio_hemodialise",
      tipo: "pergunta",
      titulo: "Hemodiálise — avaliar indicação",
      conteudo: "Nível > 2,0 mEq/L ou presença de sintomas graves?",
      opcoes: [
        { label: "Sim — nível > 2,0 ou sintomas graves", proximo: "litio_dialise_indicada" },
        { label: "Não — nível ≤ 2,0 e sem sintomas graves", proximo: "litio_controle" },
      ],
    },
    {
      id: "litio_dialise_indicada",
      tipo: "resultado",
      titulo: "Hemodiálise indicada",
      conteudo: "Principal intervenção para intoxicação grave — remove o lítio rapidamente.",
      alerta: { tipo: "perigo", texto: "Indicação absoluta: convulsão, coma ou nível > 3,5 mEq/L. Acionar nefrologia urgente." },
      acoes: [
        "Acionar nefrologia para hemodiálise urgente",
        "Indicação absoluta: convulsão, coma, nível > 3,5 mEq/L, falência renal",
        "Indicação relativa: nível > 2,5 mEq/L com sintomas neurológicos ou renais",
        "UTI durante e após hemodiálise",
        "Coletar litemia de controle 6–8h após hemodiálise (risco de rebote)",
        "Suporte neurológico e cardíaco conforme necessidade",
      ],
    },
    {
      id: "litio_controle",
      ...
      conteudo: "Intoxicação leve-moderada — hidratação e observação.",
      acoes: [
        "Hidratação IV contínua com SF 0,9%",
        "Litemia de controle a cada 6–8h",
        "Monitorização de eletrólitos e função renal",
        "Alta apenas com litemia decrescente e < 1,0 mEq/L",
        "Revisão dos fatores precipitantes: desidratação, interações medicamentosas, dose",
        "Reintrodução de lítio somente após reavaliação cardiológica e renal",
      ],
    },
  ],
};
...
// ─── CATATONIA ────────────────────────────────────────────────────────────────
const catatonia: Protocolo = {
  id: "catatonia",
  titulo: "Catatonia",
  area: "catatonia",
  cor: "purple",
  descricao: "Reconhecimento e manejo da síndrome catatônica — lorazepam como teste diagnóstico e terapêutico.",
  tempo_min: 10,
  plano: "free",
  referencia: "Fink M, Taylor MA. Cambridge, 2003; DSM-5-TR. APA.",
  inicio: "cat_reconhecimento",
  nos: [
    {
      id: "cat_reconhecimento",
      tipo: "info",
      titulo: "Reconhecimento — Critérios DSM-5-TR",
      conteudo: "Diagnóstico de catatonia requer ≥ 3 dos 12 critérios abaixo:",
      acoes: [
        "1. Estupor — ausência de atividade psicomotora, sem relação com o ambiente",
        "2. Catalepsia — manutenção passiva de postura imposta pelo examinador",
        "3. Flexibilidade cérea — resistência leve e uniforme ao reposicionamento",
        "4. Mutismo — ausência ou redução marcante da fala",
        "5. Negativismo — resistência a instruções ou estímulos externos",
        "6. Postura inadequada — manutenção espontânea de postura estranha",
        "7. Maneirismos — caricatura estranha de ações normais",
        "8. Estereotipias — movimentos repetitivos, não dirigidos a objetivo",
        "9. Agitação não influenciada pelo ambiente externo",
        "10. Careta",
        "11. Ecolalia — repetição da fala do examinador",
        "12. Ecopraxia — imitação dos movimentos do examinador",
      ],
      proximo: "cat_aviso_antipsicótico",
    },
    {
      id: "cat_aviso_antipsicótico",
      tipo: "aviso",
      titulo: "NUNCA iniciar antipsicótico antes de lorazepam",
      conteudo: "Antipsicóticos antes do lorazepam podem piorar a catatonia e precipitar SNM.",
      alerta: { tipo: "perigo", texto: "CONTRAINDICADO: antipsicótico como primeira medida em catatonia. Inicie com lorazepam IV/IM." },
      proximo: "cat_teste_lorazepam",
    },
    {
      id: "cat_teste_lorazepam",
      tipo: "acao",
      titulo: "Teste diagnóstico-terapêutico — Lorazepam",
      conteudo: "Lorazepam é ao mesmo tempo diagnóstico e tratamento de primeira linha.",
      acoes: [
        "Lorazepam 1–2 mg IV (ou IM se sem acesso venoso)",
        "Reavaliar em 60 minutos",
        "Resposta positiva: redução parcial ou total dos sintomas catatônicos",
        "Manter monitorização de sinais vitais e nível de consciência",
      ],
      proximo: "cat_resposta",
    },
    {
      id: "cat_resposta",
      tipo: "pergunta",
      titulo: "Resposta ao lorazepam?",
      conteudo: "Houve melhora dos sintomas catatônicos após 60 minutos?",
      opcoes: [
        { label: "Sim — respondeu ao lorazepam", proximo: "cat_manutencao" },
        { label: "Não — sem resposta ao lorazepam", proximo: "cat_refratario" },
      ],
    },
    {
      id: "cat_manutencao",
      tipo: "resultado",
      titulo: "Resposta positiva — Manutenção com lorazepam",
      conteudo: "Continuar lorazepam e investigar causa de base.",
      acoes: [
        "Lorazepam 1–2 mg IV ou IM a cada 6 horas",
        "Titular para controle dos sintomas com menor sedação possível",
        "Investigar causa de base (ver nó de investigação)",
        "Evitar interrupção abrupta do lorazepam após resposta — risco de rebote",
        "Reavaliar indicação de ECT se refratário após 48–72h",
      ],
      proximo: "cat_investigacao",
    },
    {
      id: "cat_refratario",
      tipo: "resultado",
      titulo: "Sem resposta — ECT urgente",
      conteudo: "Catatonia refratária ao lorazepam tem indicação de ECT.",
      alerta: { tipo: "perigo", texto: "Catatonia maligna com hipertermia = emergência médica. ECT urgente pode ser lifesaving." },
      acoes: [
        "Repetir lorazepam 2 mg IV",
        "Acionar psiquiatria para indicação de ECT urgente",
        "ECT é o tratamento mais eficaz para catatonia refratária",
        "Suporte intensivo: hidratação, nutrição enteral, prevenção de TVP",
        "Catatonia maligna (hipertermia + instabilidade autonômica): UTI + ECT prioritário",
      ],
      proximo: "cat_investigacao",
    },
    {
      id: "cat_investigacao",
      tipo: "info",
      titulo: "Investigação — excluir causa orgânica",
      conteudo: "Catatonia pode ser de causa psiquiátrica ou orgânica — investigar sempre:",
      acoes: [
        "Encefalite autoimune: painel de anticorpos (anti-NMDA, LGI1, CASPR2) no LCR e soro",
        "Epilepsia: EEG (estado de mal não-convulsivo pode mimetizar catatonia)",
        "Doenças sistêmicas: função tireoidiana, cálcio, sódio, glicemia, função renal/hepática",
        "Neuroimagem: RM de crânio com contraste",
        "LCR: citologia, proteína, glicose, cultura, autoanticorpos",
        "Causas psiquiátricas: esquizofrenia, TAB (mais comum), depressão psicótica",
      ],
      proximo: "cat_ect_indicacao",
    },
    {
      id: "cat_ect_indicacao",
      tipo: "resultado",
      titulo: "ECT — Indicações e manutenção",
      conteudo: "Tratamento de alta eficácia, frequentemente subutilizado.",
      acoes: [
        "Indicado se refratário a 48–72h de lorazepam IV adequado",
        "Indicado na catatonia maligna com hipertermia (emergência)",
        "Resposta ao ECT: 80–90% dos casos de catatonia",
        "Após resolução: manutenção com BZD + tratar causa de base (antipsicótico cauteloso se necessário)",
        "Reintroduzir antipsicótico somente após resolução completa da catatonia",
      ],
    },
  ],
};
...
const conversiva: Protocolo = {
  id: "conversiva",
  titulo: "Crise Dissociativa / Conversiva",
  area: "conversiva",
  cor: "blue",
  descricao: "Abordagem da crise psicogênica não epiléptica (CPNE) no pronto-socorro.",
  tempo_min: 8,
  plano: "free",
  referencia: "LaFrance WC et al. Epilepsia. 2013; DSM-5-TR.",
  inicio: "conv_aviso",
  nos: [
    {
      id: "conv_aviso",
      tipo: "aviso",
      titulo: "NUNCA administrar anticonvulsivantes para CPNE",
      conteudo: "Anticonvulsivantes não têm benefício nas crises psicogênicas e reforçam o papel de doente epiléptico.",
      alerta: { tipo: "perigo", texto: "NÃO administrar BZD ou anticonvulsivante para CPNE: sem benefício, com efeitos adversos e risco de reforço comportamental." },
      proximo: "conv_diferencial",
    },
    {
      id: "conv_diferencial",
      tipo: "pergunta",
      titulo: "Características da crise — epiléptica ou conversiva?",
      conteudo: "Avalie as características semiológicas da crise:",
      sub: "Olhos fechados durante a crise, movimentos assincrônicos dos membros, duração > 2 min, ausência de período pós-ictal, trauma emocional precipitante, história de trauma psicológico",
      opcoes: [
        { label: "Características sugestivas de CPNE (≥ 2 dos acima)", proximo: "conv_abordagem_aguda" },
        { label: "Características sugestivas de epilepsia", proximo: "conv_diferencial_eeg" },
        { label: "Incerto — misto ou sem informação suficiente", proximo: "conv_diferencial_eeg" },
      ],
    },
    {
      id: "conv_diferencial_eeg",
      tipo: "info",
      titulo: "Diferencial com epilepsia — papel do EEG",
      conteudo: "Pontos importantes para o diagnóstico diferencial:",
      acoes: [
        "EEG interictal normal NÃO exclui epilepsia — apenas a atividade ictal no EEG confirma",
        "Vídeo-EEG durante a crise é o padrão ouro para distinguir CPNE de epilepsia",
        "Prolactina sérica 15–20 min após crise: eleva-se em crises tônico-clônicas, não em CPNE",
        "CPNE e epilepsia podem coexistir no mesmo paciente (20–30% dos casos)",
        "Encaminhar para monitorização prolongada com vídeo-EEG em ambulatório de epilepsia",
      ],
      proximo: "conv_abordagem_aguda",
    },
    {
      id: "conv_abordagem_aguda",
      tipo: "acao",
      titulo: "Abordagem aguda no pronto-socorro",
      conteudo: "Manejo não farmacológico é o padrão para CPNE.",
      acoes: [
        "Ambiente calmo, reduzir estímulos (luz, barulho, número de profissionais)",
        "Presença de familiar de confiança se disponível",
        "NÃO administrar BZD nem anticonvulsivante",
        "Posicionar em decúbito lateral para segurança",
        "Aguardar a crise ceder naturalmente — geralmente 1–5 minutos",
        "Não conter fisicamente salvo risco de queda ou lesão",
        "Monitorar sinais vitais sem intervir farmacologicamente",
      ],
      proximo: "conv_comunicacao",
    },
    {
      id: "conv_comunicacao",
      tipo: "info",
      titulo: "Comunicação do diagnóstico — abordagem empática",
      conteudo: "A forma como o diagnóstico é comunicado determina a adesão ao tratamento.",
      acoes: [
        "Após a crise, comunicar de forma empática e sem julgamento",
        "Linguagem sugerida: 'Você teve uma crise do sistema nervoso que não é epiléptica. O cérebro pode reagir a estresse de formas diferentes, e isso é real e tratável.'",
        "Evitar termos como 'fingimento', 'psicológico' ou 'é da cabeça' — reforçam estigma",
        "Explicar que o tratamento é diferente do da epilepsia",
        "Validar o sofrimento do paciente",
      ],
      proximo: "conv_encaminhamento",
    },
    {
      id: "conv_encaminhamento",
      tipo: "resultado",
      titulo: "Encaminhamento e tratamento de longo prazo",
      conteudo: "CPNE é tratável — TCC é a intervenção de maior evidência.",
      acoes: [
        "TCC para CPNE: tratamento de 1ª linha com maior nível de evidência",
        "Encaminhar para acompanhamento conjunto neurologia + psiquiatria",
        "Neurofisiologia: monitorização com vídeo-EEG para confirmar diagnóstico",
        "Investigar e tratar comorbidades psiquiátricas: TEPT, depressão, ansiedade",
        "Orientar sobre gatilhos e estratégias de regulação emocional",
        "NÃO prescrever anticonvulsivantes se diagnóstico de CPNE for confirmado",
      ],
    },
  ],
};

export const protocolos: Protocolo[] = [agitacao, delirium, suicidio, serotoninergica, snm, abstinencia_bzd, litio, catatonia, conversiva];
