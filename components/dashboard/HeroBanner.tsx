...
export function HeroBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl p-6 text-white min-h-[160px] flex flex-col justify-between"
      ...
      <div className="flex items-start justify-between relative z-10">
        <div>
          ...
          <h1 className="text-2xl font-bold leading-tight">
            {getCurrentGreeting()}, Dr. André!
          </h1>
          <p className="text-white/80 text-sm mt-1">
            Tenha uma ótima {day.toLowerCase()}. Você tem 5 compromissos hoje.
          </p>
        </div>
